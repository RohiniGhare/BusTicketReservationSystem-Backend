				...
				<table class="table">
					<thead class="thead-dark">
						<tr>
							...
							<th scope="col">Choose Bus</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${buses }" var="b">
							<tr>
								<th scope="row">${b.busId}</th>
								<td>${b.busName}</td>
								<td>${b.pricePerSeat}</td>
								<td>
								<form action="${customerId}/makePayment/${b.busId}" method=post>
								<input type="submit" value="select this bus">
								</form>
		      </td>
							</tr>
						</c:forEach>
