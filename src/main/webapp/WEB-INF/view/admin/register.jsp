  	...
  	<div class="row">
    	...
    	<div class="col">
    		<div class="container mt-3" style="width:350px;">
    			...
    			<form:form action="processForm" method="post" modelAttribute="admin">
    				<div class="form-group">
    					<label for="exampleInputName">Name</label>
    					<form:input type="text" class="form-control" id="exampleInputName" placeholder="Enter name" path="adminName" required="required"/>
    					<p style="color:red;"><form:errors path="adminName"></form:errors></p>
    				</div>
    				<div class="form-group">
